//// dynamic.js - dynamic content page elements, usually with ExtJS used to be popup.js
...
//jQuery('#newpopupfin').click(function() {
...
//code for pop-up before download

jQuery(function(){
	// Create the element and style it
	
		var el = '<form id="overlay_form" style="display:none; -moz-border-radius: 10px; -border-radius: 10px;">\
			<h1 id="donatediff" style="color: #575757; text-align: center;">Your donation makes a difference!</h1>\
			<div><img src="/content/x2.png" height="280" style="float:left; border-right:2px solid grey; margin-right: 10px;"/>\
			<p id="supportp">It is your continuous support and contribution that keeps Connexions going!</p>\
			<p id="lookforward" style="margin-top: 10px;">We look forward to your help and support always!</p>\
			</div>\
			<div style="clear:both; padding-top: 25px;">\
			<div id="butcontt">\
			<a href="#" id="donatebut">Donate Now</a>\
			<a href="#" id="closebut" >Proceed with download</a></div>\
			</div>\
			</form>';
		jQuery("body").append(jQuery(el));
		...
		//open popup
		jQuery("#newpopupfin").click(function(e){
			jQuery("#overlay_form").fadeIn(1000);
			positionPopup();
			e.preventDefault();
			//console.log(this.href);
			jQuery("#closebut").attr("href", this.href);
		});
